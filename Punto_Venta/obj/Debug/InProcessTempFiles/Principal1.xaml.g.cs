...
namespace Punto_Venta.Proveedor {
    ...
    public partial class Principal1 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Principal1).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Principal1));
        ...
        private string FindResource() {
            string[] resources = typeof(Principal1).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Principal1.xaml.g.xaml") || resource.Equals("Principal1.xaml.g.xaml"))) {
                    return resource;
                }
            }
